...
export const settingsSchema = z.object({
  ...
  showStorefrontHeader: z.boolean().optional(), showStorefrontSearch: z.boolean().optional(), showStorefrontAccount: z.boolean().optional(), showStorefrontCart: z.boolean().optional(), showStorefrontCompare: z.boolean().optional(), showStorefrontPcBuilder: z.boolean().optional(), showStorefrontTracking: z.boolean().optional(), showStorefrontAdminLogin: z.boolean().optional(), showStorefrontCategoryNav: z.boolean().optional(),
  ...
  showCategorySection: z.boolean().optional(), categorySectionEyebrow: z.string().optional(), categorySectionTitle: z.string().optional(), categorySectionDescription: z.string().optional(), categoryNavigationScrollStyle: z.enum(['manual', 'auto-left']).optional(),
  categoryNavigationImages: z.array(z.object({ category: z.string(), imageUrl: z.string(), altText: z.string() })).optional(),
  showCatalogSection: z.boolean().optional(), showCatalogToolbar: z.boolean().optional(), showCatalogFilters: z.boolean().optional(), showBrandSection: z.boolean().optional(), brandSectionTitle: z.string().optional(), storefrontBrands: z.array(z.string()).optional(), showRecentlyViewedSection: z.boolean().optional(), recentlyViewedEyebrow: z.string().optional(), recentlyViewedTitle: z.string().optional(), showTrustSection: z.boolean().optional(),
  trustSectionEyebrow: z.string().optional(), trustSectionTitle: z.string().optional(), trustDeliveryTitle: z.string().optional(), trustDeliveryText: z.string().optional(), trustReturnsTitle: z.string().optional(), trustReturnsText: z.string().optional(), trustPaymentTitle: z.string().optional(), trustPaymentText: z.string().optional(), trustSupportTitle: z.string().optional(), trustSupportText: z.string().optional(),
  ...
  showStorefrontFooter: z.boolean().optional(), showFooterBrandColumn: z.boolean().optional(), showFooterCategoriesColumn: z.boolean().optional(), showFooterCustomerCareColumn: z.boolean().optional(), showFooterLegalBar: z.boolean().optional(), showFooterPolicyLinks: z.boolean().optional(), privacyPolicyUrl: z.string().optional(), termsUrl: z.string().optional(), returnsPolicyUrl: z.string().optional(), shippingPolicyUrl: z.string().optional(), footerCategoriesHeading: z.string().optional(), footerCustomerCareHeading: z.string().optional(), footerWarrantyText: z.string().optional(), footerReturnsText: z.string().optional(), footerShippingText: z.string().optional(), footerCopyrightText: z.string().optional(), footerOwnershipText: z.string().optional(), footerPaymentsText: z.string().optional()
});
