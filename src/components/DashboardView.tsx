...
export default function DashboardView({
  ...
  const ALL_TABS = [
    ...
    { id: 'master-data',       label: 'Store Lookup Tables & Setup', icon: SlidersHorizontal, group: 'Catalog' },
    ...
    { id: 'trade-accounts',    label: 'Wholesale & Business Accounts', icon: Building2, group: 'Sales' },
    { id: 'refurb',            label: 'Refurbished Hardware Testing', icon: Wrench, group: 'Operations' },
