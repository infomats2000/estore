...
export const SuperAdminDashboard: React.FC<SuperAdminDashboardProps> = ({ onBackToApp, onLogout, onImpersonateStore, currentUser }) => {
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-100 text-slate-800 font-sans selection:bg-blue-500 selection:text-white pb-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500 font-medium">Platform Tenants &amp; Financial Ledger</p>
              </div>
            </div>
          </div>
